...
local BatInfo = {
	-- Keep the starting Wooden bat unchanged while higher tiers scale with tougher crates.
	CreateBat({
		Id = "WoodenBat",
	...
	CreateBat({
		...
		Icon = "DiamondBat",
		-- Upper bat upgrades make Legendary crates progressively quicker to break.
		CrateDamage = 2_000,
		SwingCooldown = 0.42,
		Range = 8,
	}),
	...
	CreateBat({
		...
		Icon = "MeteoriteBat",
		-- Four hits on Legendary while leaving Mythical and Secret as longer endgame targets.
		CrateDamage = 8_000,
		SwingCooldown = 0.37,
		Range = 8.5,
	}),
