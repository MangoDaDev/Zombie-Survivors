local CleaningConfig = {
	...
	Tools = {
		...
		},
		{
			...
			LoopSoundName = "SlowSwoosh", RadiusStuds = 0.471, StrengthPerSecond = 2.4, PositionResponsiveness = 32,
			SurfaceRotationDegrees = Vector3.new(0, 90, 0),
		},
		{
			Id = "Polisher", DisplayName = "Polisher", TemplateName = "Polisher", VFXStartPartName = "PolishingPadFront",
			LoopSoundName = "Rolling", RadiusStuds = 0.582, StrengthPerSecond = 1.9, PositionResponsiveness = 28,
			SurfaceRotationDegrees = Vector3.new(0, 90, 0),
		},
		{
			Id = "Hairdryer", DisplayName = "Hairdryer", TemplateName = "Hairdryer", VFXStartPartName = "Handle",
			LoopSoundName = "Wind", LoopSoundVolume = 0.55, RadiusStuds = 0.945, StrengthPerSecond = 3.4,
		...
		},
		{
			...
			RadiusStuds = 0.417, StrengthPerSecond = 5, PositionResponsiveness = 36, StrikeInterval = 0.28,
			ImpactSoundName = "MetalHitSoft",
		},
		{
			Id = "Magnet", DisplayName = "Magnet", TemplateName = "Magnet", VFXStartPartName = "Magnet",
			LoopSoundName = "MagnetEquip", RadiusStuds = 0.639, StrengthPerSecond = 1.8, PositionResponsiveness = 26,
			PullDistance = 1.4,
		},
	},
	Steps = {
