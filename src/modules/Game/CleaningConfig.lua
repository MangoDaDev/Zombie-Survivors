local CleaningConfig = {
	...
	ItemCameraSmallItemThreshold = 2.5,
	ItemCameraSmallItemExtraDistance = 0.45,
	...
	Tools = {
		...
		},
		{
			...
			LoopSoundName = "SlowSwoosh", RadiusStuds = 0.157, StrengthPerSecond = 2.4, PositionResponsiveness = 32,
			SurfaceRotationDegrees = Vector3.new(0, 90, 0),
		},
		{
			Id = "Polisher", DisplayName = "Polisher", TemplateName = "Polisher", VFXStartPartName = "PolishingPadFront",
			LoopSoundName = "Rolling", RadiusStuds = 0.194, StrengthPerSecond = 1.9, PositionResponsiveness = 28,
			SurfaceRotationDegrees = Vector3.new(0, 90, 0),
		},
		{
			Id = "Hairdryer", DisplayName = "Hairdryer", TemplateName = "Hairdryer", VFXStartPartName = "Handle",
			LoopSoundName = "Wind", LoopSoundVolume = 0.55, RadiusStuds = 0.315, StrengthPerSecond = 3.4,
		...
		},
		{
			...
			RadiusStuds = 0.139, StrengthPerSecond = 5, PositionResponsiveness = 36, StrikeInterval = 0.28,
			ImpactSoundName = "MetalHitSoft",
		},
		{
			Id = "Magnet", DisplayName = "Magnet", TemplateName = "Magnet", VFXStartPartName = "Magnet",
			LoopSoundName = "MagnetEquip", RadiusStuds = 0.213, StrengthPerSecond = 1.8, PositionResponsiveness = 26,
			PullDistance = 1.4,
		},
	},
	Steps = {
