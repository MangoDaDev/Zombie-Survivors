local UpgradeConfig = {
	...
	Upgrades = {
		...
		},
		{
			...
			Branch = "Restoration",
			ShortValue = "Speed I",
			Effect = { Type = "ToolStrength", ToolId = "Spray", Multiplier = 1.15, RadiusMultiplier = 1.1 },
		},
		{
			Id = "SpraySpeed2",
			Name = "Spray Speed II",
			...
			Branch = "Restoration",
			ShortValue = "Speed II",
			Effect = { Type = "ToolStrength", ToolId = "Spray", Multiplier = 1.35, RadiusMultiplier = 1.2 },
		},
		{
			Id = "SpraySpeed3",
			...
			Effect = { Type = "ToolStrength", ToolId = "Spray", Multiplier = 1.65, RadiusMultiplier = 1.35 },
		},
		{
			Id = "UnlockSprayPaint",
		...
		},
		{
			...
			Branch = "Restoration",
			ShortValue = "Speed I",
			Effect = { Type = "ToolStrength", ToolId = "SprayPaint", Multiplier = 1.15, RadiusMultiplier = 1.1 },
		},
		{
			Id = "SprayPaintSpeed2",
			Name = "Paint Speed II",
			...
			Branch = "Restoration",
			ShortValue = "Speed II",
			Effect = { Type = "ToolStrength", ToolId = "SprayPaint", Multiplier = 1.35, RadiusMultiplier = 1.2 },
		},
		{
			Id = "SprayPaintSpeed3",
			...
			Branch = "Restoration",
			ShortValue = "Speed III",
			Effect = { Type = "ToolStrength", ToolId = "SprayPaint", Multiplier = 1.65, RadiusMultiplier = 1.35 },
		},
		{
			Id = "UnlockSponge",
			Name = "Unlock Sponge",
		...
		},
		{
			...
			Branch = "Restoration",
			ShortValue = "Speed I",
			Effect = { Type = "ToolStrength", ToolId = "Sponge", Multiplier = 1.15, RadiusMultiplier = 1.1 },
		},
		{
			Id = "SpongeSpeed2",
			...
			Branch = "Restoration",
			ShortValue = "Speed II",
			Effect = { Type = "ToolStrength", ToolId = "Sponge", Multiplier = 1.35, RadiusMultiplier = 1.2 },
		},
		{
			Id = "SpongeSpeed3",
			...
			Branch = "Restoration",
			ShortValue = "Speed III",
			Effect = { Type = "ToolStrength", ToolId = "Sponge", Multiplier = 1.65, RadiusMultiplier = 1.35 },
		},
		{
			Id = "WoodenBat",
			Name = "Wooden Bat",
