...
local ZombieDefinitions = {
	Walker = define({}),
	Runner = define({
		AssetName = "Runner", MaxHealth = 70, CoinValue = 3, MoveSpeed = 14, TurnSpeed = 12,
	...
	Brute = define({
		AssetName = "Brute", MaxHealth = 300, CoinValue = 12, MoveSpeed = 5.5, TurnSpeed = 5,
	...
	Spitter = define({
		MaxHealth = 65, MoveSpeed = 5.5, TintColor = Color3.fromRGB(120, 225, 62), SpecialBehavior = "Spitter",
		Special = { Range = 34, MinimumRange = 10, Cooldown = 3.8, Windup = 0.8, ProjectileSpeed = 32, ImpactRadius = 3.5, Damage = 8 },
	}),
	Charger = define({
		AssetName = "Runner", MaxHealth = 150, MoveSpeed = 9, AttackDamage = 6,
	...
	Screamer = define({
		MaxHealth = 55, MoveSpeed = 5, TintColor = Color3.fromRGB(196, 94, 220), SpecialBehavior = "Screamer",
		Special = { Cooldown = 13, Windup = 1.4, MinimumCount = 2, MaximumCount = 3, SpawnRadius = 4.5, SpawnType = "Walker" },
	}),
	Tank = define({
		AssetName = "Brute", MaxHealth = 850, MoveSpeed = 3.4, TurnSpeed = 3.5, AttackDamage = 14,
	...
	Leaper = define({
		AssetName = "Runner", MaxHealth = 60, MoveSpeed = 10, TintColor = Color3.fromRGB(246, 184, 58),
	...
	Shielder = define({
		AssetName = "Brute", MaxHealth = 270, MoveSpeed = 5, TurnSpeed = 5, ModelScale = 1.08,
	...
	Bomber = define({
		AssetName = "Runner", MaxHealth = 60, MoveSpeed = 9, TintColor = Color3.fromRGB(244, 73, 58),
	...
	Grabber = define({
		MaxHealth = 145, MoveSpeed = 5.5, TintColor = Color3.fromRGB(56, 166, 158), SpecialBehavior = "Grabber",
		Special = { MinimumRange = 5, Range = 20, Windup = 0.75, Damage = 5, PullSpeed = 34, UpwardSpeed = 5, Cooldown = 5 },
	}),
	Summoner = define({
		AssetName = "Brute", MaxHealth = 180, MoveSpeed = 3.2, ModelScale = 1.12,
	...
	Splitter = define({
		MaxHealth = 150, MoveSpeed = 9, ModelScale = 1.15, TintColor = Color3.fromRGB(76, 196, 126),
	...
	Splitling = define({
		AssetName = "Runner", MaxHealth = 38, MoveSpeed = 16, AttackDamage = 2, ModelScale = 0.68,
		SeparationRadius = 1.1, TintColor = Color3.fromRGB(112, 224, 151), AnimationStyle = "Runner",
	}),
	Burrower = define({
		AssetName = "Runner", MaxHealth = 150, MoveSpeed = 9, TintColor = Color3.fromRGB(132, 91, 55),
	...
	Frenzy = define({
		MaxHealth = 150, MoveSpeed = 5.5, TintColor = Color3.fromRGB(235, 74, 116), SpecialBehavior = "Frenzy",
		Special = { HealthThreshold = 0.55, Duration = 6, SpeedMultiplier = 2.5 },
	}),
	Medic = define({
		MaxHealth = 60, MoveSpeed = 5, TintColor = Color3.fromRGB(75, 225, 205), SpecialBehavior = "Medic",
		Special = { Radius = 16, HealAmount = 24, Cooldown = 4, PulseDuration = 0.7 },
	}),
	Hardened = define({
		AssetName = "Brute", MaxHealth = 280, MoveSpeed = 5, ModelScale = 1.08,
		TintColor = Color3.fromRGB(132, 145, 158), SpecialBehavior = "Hardened", AnimationStyle = "Brute",
		Special = { Armor = 180 },
	}),
	Dodger = define({
		AssetName = "Runner", MaxHealth = 60, MoveSpeed = 15, TurnSpeed = 14,
