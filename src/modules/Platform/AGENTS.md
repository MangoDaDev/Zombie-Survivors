...
- Platform contains helpers built around Roblox platform services, account identity, thumbnails, ranks, and synchronized server time.
...
- `Ranks.lua` is declarative project data imported from Studio; update its user IDs and display metadata deliberately.
